...
public class CallerService_rxtx implements SerialPortEventListener, Runnable, CallerServiceInterface {
	static Logger log = Logger.getLogger(CallerService_rxtx.class);
	...
	public static void main(String[] args) throws IOException {
		CallerServiceInterface cs = new CallerService_rxtx();
		String msg = "86109613 来电:<h1>" + "898989899" + "</h1>" + "林业局";
		//cs.sendBroadCast(msg);

	}

	public CallerService_rxtx() {
	}

	public CallerService_rxtx(String port, String localNo, String recordPath) {
